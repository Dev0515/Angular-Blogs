...
export class RegisterComponent implements OnInit {  
  ...
  .subscribe(res => {
    ...
    {
      this._http.post("https://api.cosmicjs.com/v1/fc12db90-b5c1-11e8-a352-25ca4a173972/add-object/",{title: credentials.username, slug: credentials.username,type_slug:'registerusers', write_key:credentials.write_key,
